...
import logoAsset from "@/assets/lg-logo.png.asset.json";
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        <a href="#top" className="flex items-center gap-3 group" aria-label="Lucas Gabriel home">
          {/* Logo placeholder */}
          <div className="relative h-10 w-10 rounded-xl gradient-purple grid place-items-center font-bold text-white text-lg shadow-lg shadow-primary/30 transition-transform group-hover:scale-105">
            LG
